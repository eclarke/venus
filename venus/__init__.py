...
class VenusValidationError(Exception):
...
def create_config(**kwargs):
    schema = yaml.safe_load(
        resource_stream("venus", "data/config.schema.yaml").read().decode())
    out =  "# Venus configuration file\n"
    out += "# Created with Venus v{}\n\n".format(__version__)
